...
build-1656695601:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-1656695601-inproc

build-1656695601-inproc: ../empty_min.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-1656695601 ../empty_min.cfg
configPkg/compiler.opt: build-1656695601
configPkg/: build-1656695601
